...
const TABS = [
  { key: "produtos", label: "Produtos", icon: Shield      },
  { key: "planos",   label: "Planos",   icon: ListChecks  },
] as const;
  ...
  return (
    <div className="flex flex-col gap-5">
      <div>
        ...
        <p className="text-[13px] text-dim-500 mt-0.5">Gestão de produtos, subscrições e renovações</p>
      </div>
