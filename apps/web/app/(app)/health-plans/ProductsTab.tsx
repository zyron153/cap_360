    ...
    <>
      ...
      <Modal open={newOpen} onClose={() => { setNewOpen(false); setFormErr(""); }} title="Novo Produto de Plano" size="md">
        <div className="px-6 py-5 grid grid-cols-2 gap-4">
          ...
          <Field label="Ciclo de Renovação" hint="Usado ao renovar um plano">
            <select value={form.durationMonths} onChange={e => set("durationMonths", e.target.value)} className={inputCls}>
